...
import com.vortex.soft.coctailapp.presentation.viewmodel.AlcoholicsViewModel
...
import kotlinx.android.synthetic.main.fragment_alcoholics.*
import org.koin.androidx.scope.lifecycleScope
import org.koin.androidx.viewmodel.ext.android.sharedViewModel
import org.koin.core.parameter.parametersOf

class AlcoholicsFragment : BaseFragment() {

    private val alcoholicsAdapter: DrinkInfoAdapter by lifecycleScope.inject{ parametersOf(::switchDrinkFragment) }
    private val alcoholicsViewModel: AlcoholicsViewModel by sharedViewModel()
    override fun layoutId() = R.layout.fragment_alcoholics
    ...
    private fun renderDrinksList(dusers: List<DDrinkInfo>?) {
        alcoholicsAdapter.drinks = dusers.orEmpty()
        hideProgress()
    ...
    private fun loadDrinkList() {
        showProgress()
        alcoholicsViewModel.loadAlcoholics()
    }
}